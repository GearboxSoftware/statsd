...
describe Statsd do
  ...
  describe "stat names" do
    it "should accept anything as stat" do
      @statsd.increment(Object, sample_rate: 1)
    end
    ...
    describe "custom delimiter" do
      ...
      it "should replace ruby constant delimiter with custom delimiter" do
        ...
        @statsd.increment(Statsd::SomeOtherClass, sample_rate: 1)
    ...
    it "should replace statsd reserved chars in the stat name" do
      @statsd.increment('ray@hostname.blah|blah.blah:blah', sample_rate: 1)
